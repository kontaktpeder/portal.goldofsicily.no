...
const dict = {
  ...
  lot_history: { no: "Historikk", en: "History" },
  lot_history_empty: { no: "Ingen hendelser registrert ennå.", en: "No events recorded yet." },
  lot_actions: { no: "Handlinger", en: "Actions" },
  lot_close: { no: "Lukk LOT", en: "Close LOT" },
  lot_close_hint: {
    no: "Lukking stopper nye leveringer. LOT-et kan fortsatt tilbakekalles senere.",
    en: "Closing stops new deliveries. The LOT can still be recalled later.",
  },
  lot_close_confirm: { no: "Bekreft lukking", en: "Confirm close" },
  lot_close_cancel: { no: "Avbryt", en: "Cancel" },
  lot_close_done: { no: "LOT lukket", en: "LOT closed" },
  lot_recall_start: { no: "Start tilbakekalling", en: "Start recall" },
  lot_recall_hint: {
    no: "Tilbakekalling overstyrer også et lukket LOT. Alle berørte mottakere vises før du bekrefter.",
    en: "Recall also overrides a closed LOT. All affected recipients are listed before you confirm.",
  },
  lot_recall_reason: { no: "Årsak til tilbakekalling", en: "Recall reason" },
  lot_recall_reason_required: {
    no: "Skriv inn årsak før du bekrefter tilbakekalling.",
    en: "Enter a reason before confirming the recall.",
  },
  lot_recall_recipients: { no: "Berørte mottakere", en: "Affected recipients" },
  lot_recall_no_recipients: {
    no: "Ingen overlevering eller levering registrert ennå.",
    en: "No handover or venue delivery recorded yet.",
  },
  lot_recall_confirm: { no: "Bekreft tilbakekalling", en: "Confirm recall" },
  lot_recall_cancel: { no: "Avbryt", en: "Cancel" },
  lot_recall_done: { no: "Tilbakekalling startet", en: "Recall started" },
  lot_events_schema_missing: {
    no: "Hendelsestabellen mangler. Kjør sql/15_lot_events.sql i Lovable Cloud SQL Editor (etter sql/14_lot_producers.sql).",
    en: "The event table is missing. Run sql/15_lot_events.sql in the Lovable Cloud SQL Editor (after sql/14_lot_producers.sql).",
  },
  lot_event_created: { no: "LOT opprettet", en: "LOT created" },
  lot_event_packed: { no: "LOT pakket", en: "LOT packed" },
  lot_event_closed: { no: "LOT lukket", en: "LOT closed" },
  lot_event_recalled: { no: "Tilbakekalt", en: "Recalled" },
  lot_handover_blocked: {
    no: "LOT-et er lukket eller tilbakekalt. Nye overleveringer er stoppet.",
    en: "This LOT is closed or recalled. New handovers are stopped.",
  },
  lot_closed_note: {
    no: "Lukket — ikke bruk videre. Kan fortsatt tilbakekalles.",
    en: "Closed — do not use further. Can still be recalled.",
  },
  lot_recalled_note: { no: "Tilbakekalt", en: "Recalled" },
  lot_goto_handover: { no: "Registrer overlevering", en: "Record handover" },
  no_production_staff: {
