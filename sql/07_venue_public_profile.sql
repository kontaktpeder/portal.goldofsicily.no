...
-- Offentlig profil ligger på serveringsstedet, ikke på fakturakunden.
-- partner = Gold Partner-profil på goldofsicily.no
-- listing = synlig sted uten merke (levering / Gold Supply-steder)
