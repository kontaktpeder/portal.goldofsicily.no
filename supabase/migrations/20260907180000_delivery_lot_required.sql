-- Kjør i Lovable Cloud → SQL. Krever at sql/10_gold_lots.sql allerede er kjørt.
-- Ingen delivery_line med quantity > 0 uten gold_lot_id.
-- Nye/oppdaterte rader kan heller ikke overstige gjenværende Gold-LOT
-- (produced_qty minus andre delivery_lines på samme LOT).
-- CHECK er NOT VALID slik at eksisterende rader ikke blokkerer migreringen;
-- INSERT/UPDATE sjekkes likevel, og triggeren håndhever regelen rigid.
